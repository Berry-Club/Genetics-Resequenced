...
import dev.aaronhowser.mods.genetics_resequenced.effect.BleedEffect
import dev.aaronhowser.mods.genetics_resequenced.effect.DoNothingEffect
import dev.aaronhowser.mods.genetics_resequenced.effect.PanaceaEffect
import dev.aaronhowser.mods.genetics_resequenced.effect.ZombifyVillagerEffect
...
object ModEffects {
	...
	val EFFECT_REGISTRY: DeferredRegister<MobEffect> =
		DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, GeneticsResequenced.MOD_ID)
