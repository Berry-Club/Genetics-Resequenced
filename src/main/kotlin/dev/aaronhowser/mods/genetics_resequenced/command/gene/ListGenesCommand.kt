...
import dev.aaronhowser.mods.genetics_resequenced.capability.TemporaryGenesCapability.Companion.temporaryGenes
		...
		source.sendSuccess(
			{
				...
				val componentList = tempGenes.map(TemporaryGenesCapability.TemporaryGene::getComponent)
