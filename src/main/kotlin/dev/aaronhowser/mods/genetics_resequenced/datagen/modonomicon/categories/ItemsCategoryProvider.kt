package dev.aaronhowser.mods.genetics_resequenced.datagen.modonomicon.categories
...
import dev.aaronhowser.mods.genetics_resequenced.datagen.modonomicon.entries.BaseEntryProvider
	...
	fun plasmid(location: Char): BookEntryModel {
		val plasmidEntry = object : BaseEntryProvider(
			...
			override fun generatePages() {
				...
				val scareCreepers =
					ModGenes.SCARE_CREEPERS.getHolderOrThrow(registries())
