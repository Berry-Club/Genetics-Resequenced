...
object ModGeneLang {
	...
	const val UNKNOWN = "gene.genetics_resequenced.unknown"
	const val DISABLED_SUFFIX = "gene.genetics_resequenced.disabled"

	fun add(provider: ModLanguageProvider) {
		provider.apply {
			add(UNKNOWN, "Unknown")
			add(DISABLED_SUFFIX, " (Disabled)")

			fun addGene(gene: ResourceKey<Gene>, name: String) = add(gene.translationKey, name)
