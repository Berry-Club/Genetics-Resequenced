package dev.aaronhowser.mods.genetics_resequenced.compatibility.recipe.emi

import dev.aaronhowser.mods.genetics_resequenced.GeneticsResequenced
import dev.aaronhowser.mods.genetics_resequenced.compatibility.recipe.emi.recipe.AntiPlasmidEmiRecipes
import dev.aaronhowser.mods.genetics_resequenced.compatibility.recipe.emi.recipe.ModEmiInformationRecipes
import dev.aaronhowser.mods.genetics_resequenced.compatibility.recipe.emi.recipe.machine.*
import dev.aaronhowser.mods.genetics_resequenced.compatibility.recipe.emi.recipe.machine.incubator.*
...
class ModEmiPlugin : EmiPlugin {
	...
	private fun setComparisons(registry: EmiRegistry) {
		val plasmidProgressComparison =
			Comparison.compareData { it.get(ModDataComponents.PLASMID_PROGRESS.get()) }
