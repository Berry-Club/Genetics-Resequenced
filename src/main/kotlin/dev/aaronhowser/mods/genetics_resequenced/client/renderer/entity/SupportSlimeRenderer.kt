...
class SupportSlimeRenderer(
	...
	private fun getPlayerSkinRenderType(entity: SupportSlime): RenderType? {
		...
		val skinRenderType = SkullBlockRenderer.getRenderType(SkullBlock.Types.PLAYER, owner.gameProfile)
	...
	override fun render(
		...
		val lerpedRotation = 180 + Mth.rotLerp(partialTicks, entity.yRotO, entity.yRot)
