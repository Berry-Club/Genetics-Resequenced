...
object DefaultGenes {
    ...
    val BLACK_DEATH: Gene = registerGene("black_death")
        .setDnaPointsRequired(1)
        .setNegative()
        .allowMobs()
        .build()
    val GREEN_DEATH: Gene = registerGene("green_death")
        .setDnaPointsRequired(1)
        .setNegative()
        .allowMobs()
        .build()
    val WHITE_DEATH: Gene = registerGene("white_death")
        .setDnaPointsRequired(1)
        .setNegative()
        .allowMobs()
        .build()
    val GRAY_DEATH: Gene = registerGene("gray_death")
        .setDnaPointsRequired(1)
        .setNegative()
        .allowMobs()
        .build()
    val UN_UNDEATH: Gene = registerGene("un_undeath")
        .setDnaPointsRequired(1)
        .setNegative()
        .allowMobs()
        .build()
