...
class ModRecipeProvider(
	...
	override fun buildRecipes(pRecipeOutput: RecipeOutput) {
		...
		specialRecipes(pRecipeOutput)
		incubator(pRecipeOutput)
	}

	private fun specialRecipes(pRecipeOutput: RecipeOutput) {
	...
	private fun shapedRecipes(pRecipeOutput: RecipeOutput) {
	...
	private fun incubator(pRecipeOutput: RecipeOutput) {
