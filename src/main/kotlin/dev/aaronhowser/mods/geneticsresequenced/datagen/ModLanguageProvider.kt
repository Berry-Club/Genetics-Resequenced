...
class ModLanguageProvider(
    ...
    override fun addTranslations() {
        ...
        addGeneInfo(BaseModGenes.CLAWS_TWO, "Doubles the chances of inflicting Bleeding on hit.")
        addGeneInfo(
        ...
        addGeneInfo(BaseModGenes.FLIGHT, "Gives you Creative mode style flight.")
        addGeneInfo(BaseModGenes.HASTE_TWO, "Gives you the Haste II potion effect.")
        addGeneInfo(BaseModGenes.MEATY_TWO, "Causes you to occasionally drop a cooked Porkchop.")
        addGeneInfo(BaseModGenes.PHOTOSYNTHESIS, "Slowly feeds you when in direct sunlight.")
        addGeneInfo(BaseModGenes.REGENERATION_FOUR, "Gives you the Regeneration IV potion effect.")
        addGeneInfo(BaseModGenes.RESISTANCE_TWO, "Give you the Resistance II potion effect.")
        addGeneInfo(BaseModGenes.SPEED_FOUR, "Give you the Speed IV potion effect.")
        addGeneInfo(BaseModGenes.SPEED_TWO, "Give you the Speed II potion effect.")
        addGeneInfo(BaseModGenes.STRENGTH_TWO, "Give you the Strength II potion effect.")
        addGeneInfo(BaseModGenes.SCARE_ZOMBIES, "Makes Zombies run away from you.")
        addGeneInfo(BaseModGenes.SCARE_SPIDERS, "Makes Spiders and Cave Spiders run away from you.")
        addGeneInfo(BaseModGenes.BIOLUMINESCENCE, "Makes you leave behind a trail of light, which lasts a short while.")
        addGeneInfo(BaseModGenes.CLAWS, "Has a chance of inflicting Bleeding on hit.\n\nBleeding deals damage over time.")
        addGeneInfo(
            BaseModGenes.DRAGON_BREATH,
            "Allows you to use the \"Dragon's Breath\" keybind to fire a dragon fireball."
        )
        addGeneInfo(BaseModGenes.EAT_GRASS, "Allows you to right-click Grass Blocks to regain hunger.")
        addGeneInfo(
            BaseModGenes.EFFICIENCY,
            "Increases your mining speed as if you were using an Efficiency tool.\n\nStacks with Haste, as well as the actual Efficiency enchantment!"
        )
        addGeneInfo(BaseModGenes.EMERALD_HEART, "Spawns an Emerald when you die.")
        addGeneInfo(
        ...
        addGeneInfo(BaseModGenes.FIRE_PROOF, "Makes you immune to fire damage, and immediately extinguishes you.")
        addGeneInfo(BaseModGenes.HASTE, "Gives you the Haste potion effect.")
        addGeneInfo(BaseModGenes.INFINITY, "Allows you to use Bows without any Arrows in your inventory.")
        addGeneInfo(BaseModGenes.INVISIBLE, "Gives you the Invisibility potion effect.")
        addGeneInfo(
        ...
        addGeneInfo(BaseModGenes.JUMP_BOOST, "Gives you the Jump Boost potion effect.")
        addGeneInfo(BaseModGenes.KEEP_INVENTORY, "Makes you keep your inventory when you die.")
        addGeneInfo(BaseModGenes.LAY_EGG, "Makes you lay an Egg occasionally.")
        addGeneInfo(BaseModGenes.LUCK, "Gives you the Luck potion effect.")
        addGeneInfo(BaseModGenes.MEATY, "Allows you to be sheared for a raw Porkchop.")
        addGeneInfo(BaseModGenes.MILKY, "Allows you to be milked with a Bucket.")
        addGeneInfo(BaseModGenes.MOB_SIGHT, "Gives all nearby entities the Glowing potion effect.")
        addGeneInfo(BaseModGenes.MORE_HEARTS, "Gives you 10 additional hearts.")
        addGeneInfo(BaseModGenes.MORE_HEARTS_TWO, "Gives you 10 MORE additional hearts.")
        addGeneInfo(BaseModGenes.NIGHT_VISION, "Gives you the Night Vision potion effect.")
        addGeneInfo(BaseModGenes.NO_FALL_DAMAGE, "Makes you immune to fall damage.")
        addGeneInfo(BaseModGenes.NO_HUNGER, "Prevents your hunger from going below halfway.")
        addGeneInfo(BaseModGenes.POISON_IMMUNITY, "Automatically removes Poison.")
        addGeneInfo(BaseModGenes.REGENERATION, "Gives you the Regeneration potion effect.")
        addGeneInfo(BaseModGenes.RESISTANCE, "Gives you the Resistance potion effect.")
        addGeneInfo(BaseModGenes.SCARE_CREEPERS, "Makes Creepers run away from you.")
        addGeneInfo(BaseModGenes.SCARE_SKELETONS, "Makes Skeletons run away from you.")
        addGeneInfo(BaseModGenes.SHOOT_FIREBALLS, "Lets you shoot Fire Charges when you right-click Blaze Rods.")
        addGeneInfo(
            BaseModGenes.SLIMY_DEATH,
            "When you die, cancels it and spawns some Support Slimes to help you fight.\n\nHas a long cooldown."
        )
        addGeneInfo(BaseModGenes.SPEED, "Gives you the Speed potion effect.")
        addGeneInfo(BaseModGenes.STEP_ASSIST, "Lets you step up full blocks.")
        addGeneInfo(BaseModGenes.STRENGTH, "Gives you the Strength potion effect.")
        addGeneInfo(
        ...
        addGeneInfo(BaseModGenes.WALL_CLIMBING, "Lets you climb walls like a Spider.")
        addGeneInfo(BaseModGenes.WATER_BREATHING, "Keeps your air meter full.")
        addGeneInfo(BaseModGenes.WITHER_HIT, "Melee attacks inflict the Wither potion effect.")
        addGeneInfo(BaseModGenes.WITHER_PROOF, "Makes you immune to the Wither potion effect.")
        addGeneInfo(BaseModGenes.WOOLY, "Lets you be sheared for Wool.")
        addGeneInfo(
            BaseModGenes.XP_MAGNET,
            "Makes you pick up all nearby xp.\n\nDisables when sneaking, when holding an active Anti-Field Orb, or near an active Anti-Field Block."
        )
        addGeneInfo(BaseModGenes.BLINDNESS, "Inflicts the Blindness potion effect.")
        addGeneInfo(BaseModGenes.CURSED, "Inflicts the Cursed potion effect.")
        addGeneInfo(BaseModGenes.FLAMBE, "Constantly lights you on fire")
        addGeneInfo(BaseModGenes.HUNGER, "Inflicts the Hunger potion effect.")
        addGeneInfo(BaseModGenes.LEVITATION, "Inflicts the Levitation potion effect.")
        addGeneInfo(BaseModGenes.MINING_FATIGUE, "Inflicts the Mining Fatigue potion effect.")
        addGeneInfo(BaseModGenes.NAUSEA, "Inflicts the Nausea potion effect.")
        addGeneInfo(BaseModGenes.POISON, "Inflicts the Poison potion effect.")
        addGeneInfo(BaseModGenes.POISON_FOUR, "Inflicts the Poison IV potion effect.")
        addGeneInfo(BaseModGenes.SLOWNESS, "Inflicts the Slowness potion effect.")
        addGeneInfo(BaseModGenes.SLOWNESS_SIX, "Inflicts the Slowness IV potion effect.")
        addGeneInfo(BaseModGenes.SLOWNESS_FOUR, "Inflicts the Slowness VI potion effect.")
        addGeneInfo(BaseModGenes.WEAKNESS, "Inflicts the Weakness potion effect.")
        addGeneInfo(BaseModGenes.WITHER, "Inflicts the Wither potion effect.")
        addGeneInfo(BaseModGenes.BLACK_DEATH, "Instantly kills.")
        addGeneInfo(BaseModGenes.GREEN_DEATH, "Slowly kills Creepers.")
        addGeneInfo(BaseModGenes.WHITE_DEATH, "Slowly kills monsters.")
        addGeneInfo(BaseModGenes.GRAY_DEATH, "Slowly kills ageable mobs.")
        addGeneInfo(BaseModGenes.UN_UNDEATH, "Slowly kills the undead.")
        addGeneInfo(
        ...
        addGeneInfo(BaseModGenes.KNOCKBACK, "Increases the knockback of your attacks.")
        addGeneInfo(BaseModGenes.BAD_OMEN, "Inflicts the Bad Omen potion effect.")
        addGeneInfo(BaseModGenes.JOHNNY, "Deal more damage using Axes")
        addGeneInfo(BaseModGenes.CHILLING, "Has a chance of inflicting freezing damage on hit.")
        addGeneInfo(BaseModGenes.REACHING, "Increases your reach by 1.25 times.")

        add(Genes.UNKNOWN, "Unknown")
        add(Genes.DISABLED, " (Disabled)")

        addGene(BaseModGenes.BASIC, "Basic")
        addGene(BaseModGenes.HASTE_TWO, "Haste II")
        addGene(BaseModGenes.EFFICIENCY_FOUR, "Efficiency IV")
        addGene(BaseModGenes.REGENERATION_FOUR, "Regeneration IV")
        addGene(BaseModGenes.SPEED_FOUR, "Speed IV")
        addGene(BaseModGenes.SPEED_TWO, "Speed II")
        addGene(BaseModGenes.RESISTANCE_TWO, "Resistance II")
        addGene(BaseModGenes.STRENGTH_TWO, "Strength II")
        addGene(BaseModGenes.MEATY_TWO, "Meaty II")
        addGene(BaseModGenes.MORE_HEARTS_TWO, "More Hearts II")
        addGene(BaseModGenes.INVISIBLE, "Invisibility")
        addGene(BaseModGenes.FLIGHT, "Flight")
        addGene(BaseModGenes.LUCK, "Luck")
        addGene(BaseModGenes.SCARE_ZOMBIES, "Scare Zombies")
        addGene(BaseModGenes.SCARE_SPIDERS, "Scare Spiders")
        addGene(BaseModGenes.THORNS, "Thorns")
        addGene(BaseModGenes.CLAWS_TWO, "Claws II")
        addGene(BaseModGenes.CHATTERBOX, "Chatterbox")
        addGene(BaseModGenes.CHILLING, "Chilling")
        addGene(BaseModGenes.DRAGON_BREATH, "Dragon's Breath")
        addGene(BaseModGenes.EAT_GRASS, "Eat Grass")
        addGene(BaseModGenes.EMERALD_HEART, "Emerald Heart")
        addGene(BaseModGenes.ENDER_DRAGON_HEALTH, "Ender Dragon Health")
        addGene(BaseModGenes.EXPLOSIVE_EXIT, "Explosive Exit")
        addGene(BaseModGenes.FIRE_PROOF, "Fire Proof")
        addGene(BaseModGenes.ITEM_MAGNET, "Item Magnet")
        addGene(BaseModGenes.JOHNNY, "Johnny")
        addGene(BaseModGenes.JUMP_BOOST, "Jump Boost")
        addGene(BaseModGenes.MILKY, "Milky")
        addGene(BaseModGenes.MORE_HEARTS, "More Hearts")
        addGene(BaseModGenes.NIGHT_VISION, "Night Vision")
        addGene(BaseModGenes.NO_FALL_DAMAGE, "No Fall Damage")
        addGene(BaseModGenes.PHOTOSYNTHESIS, "Photosynthesis")
        addGene(BaseModGenes.POISON_IMMUNITY, "Poison Immunity")
        addGene(BaseModGenes.RESISTANCE, "Resistance")
        addGene(BaseModGenes.KNOCKBACK, "Knockback")
        addGene(BaseModGenes.KEEP_INVENTORY, "Keep Inventory")
        addGene(BaseModGenes.SCARE_CREEPERS, "Scare Creepers")
        addGene(BaseModGenes.SCARE_SKELETONS, "Scare Skeletons")
        addGene(BaseModGenes.SHOOT_FIREBALLS, "Shoot Fireballs")
        addGene(BaseModGenes.SLIMY_DEATH, "Slimy Death")
        addGene(BaseModGenes.SPEED, "Speed")
        addGene(BaseModGenes.STRENGTH, "Strength")
        addGene(BaseModGenes.TELEPORT, "Teleport")
        addGene(BaseModGenes.WATER_BREATHING, "Water Breathing")
        addGene(BaseModGenes.WOOLY, "Wooly")
        addGene(BaseModGenes.WITHER_HIT, "Wither Hit")
        addGene(BaseModGenes.WITHER_PROOF, "Wither Proof")
        addGene(BaseModGenes.XP_MAGNET, "XP Magnet")
        addGene(BaseModGenes.STEP_ASSIST, "Step Assist")
        addGene(BaseModGenes.INFINITY, "Infinity")
        addGene(BaseModGenes.BIOLUMINESCENCE, "Bioluminescence")
        addGene(BaseModGenes.LAY_EGG, "Lay Eggs")
        addGene(BaseModGenes.MEATY, "Meaty")
        addGene(BaseModGenes.NO_HUNGER, "No Hunger")
        addGene(BaseModGenes.CLAWS, "Claws")
        addGene(BaseModGenes.HASTE, "Haste")
        addGene(BaseModGenes.EFFICIENCY, "Efficiency")
        addGene(BaseModGenes.WALL_CLIMBING, "Climb Walls")
        addGene(BaseModGenes.MOB_SIGHT, "Mob Sight")
        addGene(BaseModGenes.REACHING, "Reaching")
        addGene(BaseModGenes.REGENERATION, "Regeneration")
        addGene(BaseModGenes.BAD_OMEN, "Bad Omen")
        addGene(BaseModGenes.CRINGE, "Cringe")
        addGene(BaseModGenes.POISON, "Poison")
        addGene(BaseModGenes.POISON_FOUR, "Poison IV")
        addGene(BaseModGenes.WITHER, "Wither")
        addGene(BaseModGenes.WEAKNESS, "Weakness")
        addGene(BaseModGenes.BLINDNESS, "Blindness")
        addGene(BaseModGenes.SLOWNESS, "Slowness")
        addGene(BaseModGenes.SLOWNESS_FOUR, "Slowness IV")
        addGene(BaseModGenes.SLOWNESS_SIX, "Slowness VI")
        addGene(BaseModGenes.NAUSEA, "Nausea")
        addGene(BaseModGenes.HUNGER, "Hunger")
        addGene(BaseModGenes.FLAMBE, "Flambé")
        addGene(BaseModGenes.CURSED, "Cursed")
        addGene(BaseModGenes.LEVITATION, "Levitation")
        addGene(BaseModGenes.MINING_FATIGUE, "Mining Weakness")
        addGene(BaseModGenes.GREEN_DEATH, "Green Death")
        addGene(BaseModGenes.UN_UNDEATH, "Un-Undeath")
        addGene(BaseModGenes.GRAY_DEATH, "Gray Death")
        addGene(BaseModGenes.WHITE_DEATH, "White Death")
        addGene(BaseModGenes.BLACK_DEATH, "Black Death")
        addGene(BaseModGenes.WIND_CHARGED, "Wind Charged")
        addGene(BaseModGenes.WEAVING, "Weaving")
        addGene(BaseModGenes.OOZING, "Oozing")
        addGene(BaseModGenes.INFESTED, "Infested")
