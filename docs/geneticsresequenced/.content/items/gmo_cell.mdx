...
For a full list of GMO recipes you can either use [EMI](https://www.curseforge.com/minecraft/mc-mods/emi), or check the [default GMO recipes]($geneticsresequenced:players/default_gmo_recipes) page.