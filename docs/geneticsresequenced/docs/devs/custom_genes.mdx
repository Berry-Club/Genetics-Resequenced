...
Gene definition jsons go in `/data/namespace/genetics_resequenced/gene/`. For example, the file `/data/coolmodpack/genetics_resequenced/gene/example.json` would make a Gene with the id `coolmodpack:example`.
